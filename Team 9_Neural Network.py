...
def mlp_classifier(features, target):
    """
    To train the neural network classifier with features and target data
    :param features:
    :param target:
    :return: trained neural network classifier
    """
...
def main():
    ...
    train_x, test_x, train_y, test_y = split_dataset(dataset, 0.75, HEADERS[:58], HEADERS[-1])
    ...
    trained_model = mlp_classifier(train_x, train_y)
